...
import { tagType, logo_2 } from '../assets';
    ...
    <div className="sm:w-[288px] w-full rounded-[15px] bg-[#1c1c24] cursor-pointer" onClick={handleClick}>
      ...
      <div className="flex flex-col p-4">
        ...
        <div className="flex items-center mt-[20px] gap-[12px]">
          <div className="w-[30px] h-[30px] rounded-full flex justify-center items-center bg-[#8c6dfd]">
            <img src={logo_2} alt="user" className="w-1/2 h-1/2 object-contain"/>
          </div>
